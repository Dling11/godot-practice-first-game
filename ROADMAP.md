...
- Completed the pre-Stage-IV progression/control pass: rebalanced the ten-level XP curve so Stage I's 304 XP finishes near Level 3, added Eira's free session-persistent Consecutive Thrust awakening, made Skill 2 fully invulnerable and dash-cancelable, replaced implicit weapon-card equipping with explicit safe Equip actions, prevented HUD clicks from leaking into basic attack, added a visible clickable dash cooldown and top-right Options button, enlarged vitality readability, and split the Husk attack cue into woody telegraph plus root/earth eruption layers.
...
- Feel-test Consecutive Thrust's Level-3 Eira awakening, full-cast invulnerability, dash cancellation, snapshotted direction, 128x26 lane versus oversized rapid-flurry effects, 225% total weapon damage, control resistance, final feedback, 5-second cooldown, and crowd performance at 960x540.
...
- Feel-test Orren's 18-coin shop, explicit shop/detail Equip buttons, deferred idle-safe swapping, Ashwood/Iron portrait/world consistency, and insufficient-funds messaging.
...
- Design the Thornbound Warden encounter and Cinder Sigil acquisition before enabling normal-progression access to The Rootbound Hollow.
