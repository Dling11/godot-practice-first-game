...
- Polished the implemented Forest reward loop: ordinary common/secondary materials now use protected percentage rolls instead of universal drops; pickups hop, hover, and magnetically auto-collect; reward chests are solid Y-sorted actors with a rune reveal; and Stage III now awards a distinct Rootbound Reliquary tier while preserving guaranteed boss/clear progression.
...
3. **Segment 3 - Loot and chests — implemented:** ecology-linked protected percentage drops, hop/hover/magnetic pickup presentation, guaranteed boss materials and non-empty stage-clear rewards, idempotent first-clear claims, expedition rollback/commit semantics, distinct 24x24 material art, Y-sorted colliding chests, and Forest Cache/Rootbound Reliquary presentation tiers.
