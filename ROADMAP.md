...
- Accepted Decision 077 and temporarily made King the active player proof without deleting or archiving Opaw. King now walks, idles, dashes through safe locomotion aliases, and uses a real four-direction basic-slash sheet against the existing tested melee authority; his integrated sword suppresses only the detached equipment sprite. The Character & Bag preview and four honest sealed skill slots now identify King. Opaw's compact/Wayfarer art, abilities, data, and explicit regression setup remain intact.
...
- **King active proof owner review:** launch the normal game and inspect movement, four-direction basic slash, integrated-sword readability, cleave alignment, dash alias, damage reactions, defeat fade, Sanctuary interaction, and Character & Bag at 960x540. Record visual/action drift before producing another sheet.
...
- **Milestone D — Forest campaign sequence:** retain Stage 1 introduction, Stage 2 escalation, and Stage 3 material-payout mini-boss as the first forest arc. Save/Continue, content data, sparse drops, ordinary-stage banking, the Stage III Reliquary, and the read-only Rootweaver service are complete; add crafting transactions/equipment and Hunts before Stage 4, then build Stages 4-10 one content-contract enemy at a time against the approved role/material and III/V/VIII/X reward cadence rather than improvising isolated stages.
