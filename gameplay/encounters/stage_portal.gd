...
const TIER_PRESENTATION := {
	PortalTier.NORMAL: {
		"color": Color(0.72, 0.66, 1.0), "scale": 0.88, "speed": 0.9,
	},
	PortalTier.MINI_BOSS: {
		"color": Color(0.44, 1.0, 0.72), "scale": 1.0, "speed": 1.05,
	},
	PortalTier.BOSS: {
		"color": Color(1.0, 0.38, 0.5), "scale": 1.12, "speed": 1.2,
	},
	PortalTier.GOD: {
		"color": Color(1.0, 0.84, 0.34), "scale": 1.24, "speed": 1.35,
	},
	PortalTier.TRANSCENDENT: {
		"color": Color(0.72, 0.96, 1.0), "scale": 1.36, "speed": 1.5,
	},
}
