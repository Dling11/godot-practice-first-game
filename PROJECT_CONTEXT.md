...
- Piercing Rush cast integrity: `AbilityPivot` snapshots the cast direction and ignores later movement-facing changes until the cast ends, keeping body pose, VFX, hit shape, damage, and pushback in one forward lane. Same-frame multi-target contacts keep local feedback but share camera, hitstop, and impact-audio work.
...
Feel-test Piercing Rush with Ashwood and Iron in both stages: its 0.14/0.18/0.24-second phases, roughly 50-pixel collision-limited movement, 98-pixel central lance hit path, six-frame oversized spirit-lance/impact sequence, dedicated charge/thrust/impact audio, click/`1` activation, 3-second cooldown, and 180% weapon scaling. Then measure clear time and crowd readability before extending encounters with authored reinforcement waves and mixed roles. Ground targeting, Consecutive Thrust, Eira's free awakening, disk persistence, the Thornbound Warden/Cinder Sigil, character switching, Mage/Archer kits, and god-tier content remain staged work.
