...
## Converts Opaw's separately authored action sources and Ashwood Blade source
## into deterministic, binary-alpha runtime art. Gameplay scenes never load the
## generation sources directly.

const CHARACTER_SOURCE_ROOT := "res://art_source/generated/characters/playable/opaw/v2"
const CHARACTER_OUTPUT_ROOT := "res://assets/characters/playable/opaw"
...
const CHARACTER_ACTIONS := [
	{
		"name": "idle",
		"source": "opaw_idle_source.png",
		"clean": "opaw_idle_clean.png",
		"output": "opaw_idle_sheet_32x32.png",
		"columns": 2,
		"cell_size": CHARACTER_CELL_SIZE,
	},
	{
		"name": "walk",
		"source": "opaw_walk_source.png",
		"clean": "opaw_walk_clean.png",
		"output": "opaw_walk_sheet_32x32.png",
		"columns": 4,
		"cell_size": CHARACTER_CELL_SIZE,
	},
	{
		"name": "attack_body",
		"source": "opaw_attack_body_source.png",
		"clean": "opaw_attack_body_clean.png",
		"output": "opaw_attack_body_sheet_48x32.png",
		"columns": 3,
		"cell_size": CHARACTER_ACTION_CELL_SIZE,
	},
	{
		"name": "dash",
		"source": "opaw_dash_source.png",
		"clean": "opaw_dash_clean.png",
		"output": "opaw_dash_sheet_48x32.png",
		"columns": 3,
		"cell_size": CHARACTER_ACTION_CELL_SIZE,
	},
	{
		"name": "interact",
		"source": "opaw_interact_source.png",
		"clean": "opaw_interact_clean.png",
		"output": "opaw_interact_sheet_48x32.png",
		"columns": 2,
		"cell_size": CHARACTER_ACTION_CELL_SIZE,
	},
	{
		"name": "hurt",
		"source": "opaw_hurt_source.png",
		"clean": "opaw_hurt_clean.png",
		"output": "opaw_hurt_sheet_32x32.png",
		"columns": 2,
		"cell_size": CHARACTER_CELL_SIZE,
	},
	{
		"name": "defeat",
		"source": "opaw_defeat_source.png",
		"clean": "opaw_defeat_clean.png",
		"output": "opaw_defeat_sheet_64x32.png",
		"columns": 4,
...
func _initialize() -> void:
	...
	if not _process_weapon():
		quit(1)
		return
	print("Processed Opaw's separate action sheets and Ashwood Blade runtime art.")
	quit(0)
