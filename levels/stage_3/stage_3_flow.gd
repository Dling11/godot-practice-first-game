...
func _ready() -> void:
	if player == null or combat_hud == null or character_menu == null or encounter_controller == null:
		push_error("Stage3Flow requires Player, CombatHUD, CharacterMenu, and EncounterController.")
		return
...
func _begin_stage() -> void:
	combat_hud.show_story_message("THE ASHEN ROOTS STILL HUNGER", 2.5)
...
func _on_stage_cleared() -> void:
	...
	if story_state != null:
		story_state.remember_story(&"ashen_pilgrimage_completed")
		story_state.record_boss_victory(&"rootbound_husk")
		story_state.record_discovery(&"charred_root_sanctum")
