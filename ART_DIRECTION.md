...
- King's simple down-facing face uses two single-pixel dark eyes separated vertically from the chunky black fringe by warm face pixels. Never reconnect an eye to the hair, enlarge the eyes, add white highlights, or alter the approved head/body silhouette merely to improve facial readability.
