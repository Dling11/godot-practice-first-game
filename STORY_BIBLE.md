...
The planned game supports a **switchable roster of playable souls** gathered from different worlds or eras:
...
Huge swords, catastrophic spells, impossible movement, screen fractures, black-frame cuts, and apparent reality alteration belong in later bands, but spectacle must never replace player agency. A god-tier attack is exciting because the player understands and survives it, not because the screen becomes unreadable.
...
The Grove is the first available expedition. Its corruption has begun to imitate memory, suggesting that the monsters are consequences of deliberate divine interference rather than random decay. The currently playable route establishes this mystery and records completion in story memory.
...
- A story flag means an event occurred. It must not silently grant equipment, combat stats, or character ownership.
