...
Movement, movement-owned facing, left-click primary attack, dash, portal interaction, and arena restart after defeat are active for the temporary King proof. Pressing basic attack during dash movement queues one normal slash for dash completion; pressing it during vulnerable recovery cancels that recovery into the attack. Balanced Slash currently supplies the tested 58-pixel-forward by 96-pixel-wide contact fan, while King's integrated sword and white-blue trail present the hit. King's four skills are deliberately sealed; Opaw's preserved Piercing Rush and Consecutive Thrust are not silently attached to him. The shared proof vitality still begins at 140, gains 12 per level, retains health across stages, and regenerates 1 HP/s after five damage-free seconds. F9 grants level, coins, gear, and material samples but keeps King's skill slots sealed.
