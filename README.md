...
Pre-alpha title-to-Sanctuary-to-three-stage prototype. F5 opens a mouse/keyboard/gamepad-ready Battle of Gods title screen with Continue, guarded New Journey, and session-audio settings. Opaw is a compact armless Novice Warrior with a detached equippable sword. Stages I-III form one continuous forest arc ending with the Rootbound Husk mini-boss and a return portal to Sanctuary. The five current enemies roll illustrated Forest materials as hopping, hovering, magnetic world pickups, and each final wave spawns a guaranteed colliding stage-clear chest that must be claimed before its portal opens. Stages I-II use the ordinary Forest Cache while the Stage III mini-boss awards a distinct Rootbound Reliquary. XP/coins, current HP, story memory, Skill 2 awakening, Ashwood/Iron ownership/equip, earned material quantities, recipe discoveries, bad-luck counters, and first-clear claims persist through one safe-point autosave. Crafting transactions/outputs, armor bonuses, Hunts, character switching, and skills 3-4 are not yet playable.
...
Opaw's active compact armless sheets, the earlier Wayfarer pipeline, Ashwood Blade, current Sanctuary assets, Rootling's runtime atlases, and the original level-up chime can be regenerated from their active sources with:
