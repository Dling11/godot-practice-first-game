...
King establishes the new character-owned combat direction: a compact hard-pixel chibi body with simple visible arms, an integrated signature sword, a real tap/hold attack chain, four character skills, and a cinematic ultimate presentation. His late-twenties silhouette is lean, energetic, clean-faced, and deliberately not an old or heavily armored father. Future characters own their own body frames, contact silhouettes, hand anchors, skill loadouts, and story motives rather than acting as cosmetic skins over King. Equipment becomes essence/relic power that modifies the character without automatically replacing the visible signature weapon. Opaw remains active beside him. Roster switching is not implemented and should occur in Sanctuary or another safe preparation space.
...
**Proposed King kit:** `Crescent Sever` is a huge white ranged crescent and crowd opener; `Riftstep Cross` is a collision-limited invulnerable travel cut followed by a delayed X detonation; `Blade Dominion` is three escalating circular cuts with slow steering and damage reduction rather than full invulnerability; `Worldsplitter: Last Horizon` is a short cinematic forward cut plus delayed space fracture. These are distinct from Opaw's forward thrust/flurry identity and remain unimplemented until temporary-shape feel tests approve their contact and commitment.
