...
- HUD entry buttons emit gameplay intent without calculating outcomes. A shared Options entry may locate the one scene-registered `PauseMenu`, but that menu remains pause authority.
